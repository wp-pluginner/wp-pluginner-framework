...
trait RegistersExceptionHandlers
{
    ...
    {
        if ($this->bound('WpPluginner\Illuminate\Contracts\Debug\ExceptionHandler')) {
            return $this->make('WpPluginner\Illuminate\Contracts\Debug\ExceptionHandler');
        } else {
            return $this->make('WpPluginner\Lumen\Exceptions\Handler');
        }
    }
}
