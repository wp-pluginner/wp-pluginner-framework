...
namespace WpPluginner\Lumen\Concerns;
...
use WpPluginner\Lumen\Routing\Pipeline;
use WpPluginner\Illuminate\Contracts\Support\Responsable;
use WpPluginner\Lumen\Routing\Closure as RoutingClosure;
use WpPluginner\Illuminate\Http\Exceptions\HttpResponseException;
use WpPluginner\Lumen\Routing\Controller as LumenController;
...
trait RoutesRequests
{
    ...
    protected function gatherMiddlewareClassNames($middleware)
    {
        ...
        return array_map(function ($name) {
            ...
            return wp_pluginner_array_get($this->routeMiddleware, $name, $name).($parameters ? ':'.$parameters : '');
        }, $middleware);
    }
