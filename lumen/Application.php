...
class Application extends Container
{
    ...
    protected function bootstrapContainer()
    {
        ...
        $this->instance('WpPluginner\Lumen\Application', $this);
    ...
    {
        $this->singleton('WpPluginner\Illuminate\Contracts\Broadcasting\Factory', function () {
            return $this->loadComponent('broadcasting', 'WpPluginner\Illuminate\Broadcasting\BroadcastServiceProvider', 'WpPluginner\Illuminate\Contracts\Broadcasting\Factory');
        });

        $this->singleton('WpPluginner\Illuminate\Contracts\Broadcasting\Broadcaster', function () {
            return $this->loadComponent('broadcasting', 'WpPluginner\Illuminate\Broadcasting\BroadcastServiceProvider', 'WpPluginner\Illuminate\Contracts\Broadcasting\Broadcaster');
        });
    }
    ...
    {
        $this->singleton('WpPluginner\Illuminate\Contracts\Bus\Dispatcher', function () {
            $this->register('WpPluginner\Illuminate\Bus\BusServiceProvider');

            return $this->make('WpPluginner\Illuminate\Contracts\Bus\Dispatcher');
        });
    }
    ...
    protected function registerCacheBindings()
    {
        $this->singleton('cache', function () {
            return $this->loadComponent('cache', 'WpPluginner\Illuminate\Cache\CacheServiceProvider');
        });
        $this->singleton('cache.store', function () {
            return $this->loadComponent('cache', 'WpPluginner\Illuminate\Cache\CacheServiceProvider', 'cache.store');
        });
    }
    ...
    protected function registerDatabaseBindings()
    {
        $this->singleton('db', function () {
            return $this->loadComponent(
                'database', [
                    'WpPluginner\Illuminate\Database\DatabaseServiceProvider',
                    'WpPluginner\Illuminate\Pagination\PaginationServiceProvider',
                ], 'db'
            );
        });
    }
    ...
    protected function registerEncrypterBindings()
    {
        $this->singleton('encrypter', function () {
            return $this->loadComponent('app', 'WpPluginner\Illuminate\Encryption\EncryptionServiceProvider', 'encrypter');
        });
    }
    ...
    protected function registerEventBindings()
    {
        $this->singleton('events', function () {
            $this->register('WpPluginner\Illuminate\Events\EventServiceProvider');
    ...
    protected function registerHashBindings()
    {
        $this->singleton('hash', function () {
            $this->register('WpPluginner\Illuminate\Hashing\HashServiceProvider');
    ...
    protected function registerQueueBindings()
    {
        $this->singleton('queue', function () {
            return $this->loadComponent('queue', 'WpPluginner\Illuminate\Queue\QueueServiceProvider', 'queue');
        });
        $this->singleton('queue.connection', function () {
            return $this->loadComponent('queue', 'WpPluginner\Illuminate\Queue\QueueServiceProvider', 'queue.connection');
        });
    }
     ...
     * @return \WpPluginner\Illuminate\Http\Request
     */
    ...
    protected function registerTranslationBindings()
    {
        $this->singleton('translator', function () {
            ...
            $this->register('WpPluginner\Illuminate\Translation\TranslationServiceProvider');
    ...
    protected function registerValidatorBindings()
    {
        $this->singleton('validator', function () {
            $this->register('WpPluginner\Illuminate\Validation\ValidationServiceProvider');
    ...
    {
        $defaults = [
            'WpPluginner\Illuminate\Support\Facades\Auth' => 'Auth',
            'WpPluginner\Illuminate\Support\Facades\Cache' => 'Cache',
            'WpPluginner\Illuminate\Support\Facades\DB' => 'DB',
            'WpPluginner\Illuminate\Support\Facades\Event' => 'Event',
    ...
    public function prepareForConsoleCommand($aliases = true)
    {
        ...
        $this->register('WpPluginner\Lumen\Console\ConsoleServiceProvider');
    }
    ...
    protected function registerContainerAliases()
    {
        $this->aliases = [
            ...
            'WpPluginner\Illuminate\Contracts\Auth\Factory' => 'auth',
            'WpPluginner\Illuminate\Contracts\Auth\Guard' => 'auth.driver',
    ...
    public $availableBindings = [
        ...
        'WpPluginner\Illuminate\Contracts\Broadcasting\Factory' => 'registerBroadcastingBindings',
        'WpPluginner\Illuminate\Contracts\Bus\Dispatcher' => 'registerBusBindings',
        'cache' => 'registerCacheBindings',
        'cache.store' => 'registerCacheBindings',
        'WpPluginner\Illuminate\Contracts\Cache\Factory' => 'registerCacheBindings',
        'WpPluginner\Illuminate\Contracts\Cache\Repository' => 'registerCacheBindings',
        'composer' => 'registerComposerBindings',
        'config' => 'registerConfigBindings',
        'db' => 'registerDatabaseBindings',
        'WpPluginner\Illuminate\Database\Eloquent\Factory' => 'registerDatabaseBindings',
        'encrypter' => 'registerEncrypterBindings',
        'WpPluginner\Illuminate\Contracts\Encryption\Encrypter' => 'registerEncrypterBindings',
        'events' => 'registerEventBindings',
        'WpPluginner\Illuminate\Contracts\Events\Dispatcher' => 'registerEventBindings',
        'files' => 'registerFilesBindings',
        'hash' => 'registerHashBindings',
        'WpPluginner\Illuminate\Contracts\Hashing\Hasher' => 'registerHashBindings',
        ...
        'WpPluginner\Illuminate\Contracts\Validation\Factory' => 'registerValidatorBindings',
        'view' => 'registerViewBindings',
        'WpPluginner\Illuminate\Contracts\View\Factory' => 'registerViewBindings',
    ];
}
