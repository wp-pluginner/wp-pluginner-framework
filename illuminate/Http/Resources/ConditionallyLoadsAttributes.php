...
namespace WpPluginner\Illuminate\Http\Resources;
...
trait ConditionallyLoadsAttributes
{
     ...
     * @param  mixed  $value
     * @param  mixed  $default
     * @return \WpPluginner\Illuminate\Http\Resources\MissingValue|mixed
     */
    protected function when($condition, $value, $default = null)
    {
        if ($condition) {
            return wp_pluginner_value($value);
        }

        return func_num_args() === 3 ? wp_pluginner_value($default) : new MissingValue;
    }
    ...
    {
        return $condition ? new MergeValue(wp_pluginner_value($value)) : new MissingValue;
    }
     ...
     * @return \WpPluginner\Illuminate\Http\Resources\MergeValue
     */
