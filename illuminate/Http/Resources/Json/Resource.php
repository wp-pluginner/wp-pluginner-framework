...
use WpPluginner\Illuminate\Http\Resources\DelegatesToResource;
use WpPluginner\Illuminate\Http\Resources\ConditionallyLoadsAttributes;
...
class Resource implements ArrayAccess, JsonSerializable, Responsable, UrlRoutable
{
     ...
     *
     * @param  mixed  $resource
     * @return \WpPluginner\Illuminate\Http\Resources\Json\AnonymousResourceCollection
     */
     ...
     *
     * @param  \WpPluginner\Illuminate\Http\Request  $request
     * @param  \WpPluginner\Illuminate\Http\JsonResponse  $response
     * @return void
     */
