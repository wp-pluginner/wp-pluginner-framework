...
namespace WpPluginner\Illuminate\Validation\Concerns;
...
use WpPluginner\Illuminate\Validation\Rules\Exists;
use WpPluginner\Illuminate\Validation\Rules\Unique;
use WpPluginner\Illuminate\Validation\ValidationData;
...
trait ValidatesAttributes
{
    ...
    {
        if (in_array($attribute, wp_pluginner_array_collapse($this->implicitAttributes))
                && ! is_numeric($last = wp_pluginner_last(explode('.', $attribute)))) {
            return $last;
        }
