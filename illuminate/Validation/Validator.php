...
namespace WpPluginner\Illuminate\Validation;
...
use WpPluginner\Illuminate\Contracts\Translation\Translator;
use WpPluginner\Illuminate\Contracts\Validation\ImplicitRule;
use Symfony\Component\HttpFoundation\File\UploadedFile;
use WpPluginner\Illuminate\Contracts\Validation\Rule as RuleContract;
use WpPluginner\Illuminate\Contracts\Validation\Validator as ValidatorContract;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \WpPluginner\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @var \WpPluginner\Illuminate\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \WpPluginner\Illuminate\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @param  \WpPluginner\Illuminate\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @return void
     *
     * @throws \WpPluginner\Illuminate\Validation\ValidationException
     */
     ...
     * @param  string  $attribute
     * @param  mixed  $value
     * @param  \WpPluginner\Illuminate\Contracts\Validation\Rule  $rule
     * @return void
     */
    ...
    {
        return wp_pluginner_collect($this->messages()->toArray())->map(function ($message, $key) {
     ...
     *
     * @return \WpPluginner\Illuminate\Support\MessageBag
     */
    ...
    {
        if ($extensions) {
            $keys = array_map('\WpPluginner\Illuminate\Support\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\WpPluginner\Illuminate\Support\Str::snake', array_keys($replacers));
     ...
     *
     * @return \WpPluginner\Illuminate\Validation\PresenceVerifierInterface
     *
    ...
    {
        return wp_pluginner_tap($this->getPresenceVerifier(), function ($verifier) use ($connection) {
     ...
     *
     * @param  \WpPluginner\Illuminate\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \WpPluginner\Illuminate\Contracts\Translation\Translator
     */
