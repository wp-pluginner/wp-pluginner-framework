...
class Gate implements GateContract
{
    ...
    {
        return wp_pluginner_collect($abilities)->every(function ($ability) use ($arguments) {
            try {
    ...
    {
        return wp_pluginner_collect($abilities)->contains(function ($ability) use ($arguments) {
            return $this->check($ability, $arguments);
        });
    }
