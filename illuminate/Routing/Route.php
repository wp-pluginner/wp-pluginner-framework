...
use WpPluginner\Illuminate\Routing\Matching\UriValidator;
use WpPluginner\Illuminate\Routing\Matching\HostValidator;
use WpPluginner\Illuminate\Routing\Matching\MethodValidator;
use WpPluginner\Illuminate\Routing\Matching\SchemeValidator;
use WpPluginner\Illuminate\Http\Exceptions\HttpResponseException;
use WpPluginner\Illuminate\Routing\Contracts\ControllerDispatcher as ControllerDispatcherContract;
...
class Route
{
     ...
     *
     * @var \WpPluginner\Illuminate\Routing\Router
     */
    protected $router;
    ...
    {
        $groupStack = wp_pluginner_last($this->router->getGroupStack());
     ...
     *
     * @return \WpPluginner\Illuminate\Routing\Contracts\ControllerDispatcher
     */
     ...
     *
     * @param  \WpPluginner\Illuminate\Routing\Router  $router
     * @return $this
     */
