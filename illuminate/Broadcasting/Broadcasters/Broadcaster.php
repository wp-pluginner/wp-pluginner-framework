...
namespace WpPluginner\Illuminate\Broadcasting\Broadcasters;
...
abstract class Broadcaster implements BroadcasterContract
{
    ...
    protected function extractAuthParameters($pattern, $channel, $callback)
    {
        ...
        return wp_pluginner_collect($this->extractChannelKeys($pattern, $channel))->reject(function ($value, $key) {
     ...
     *
     * @return \WpPluginner\Illuminate\Contracts\Routing\BindingRegistrar
     */
