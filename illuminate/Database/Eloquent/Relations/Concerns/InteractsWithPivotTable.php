...
namespace WpPluginner\Illuminate\Database\Eloquent\Relations\Concerns;

use WpPluginner\Illuminate\Database\Eloquent\Model;
use WpPluginner\Illuminate\Database\Eloquent\Collection;
use WpPluginner\Illuminate\Support\Collection as BaseCollection;
...
trait InteractsWithPivotTable
{
     ...
     *
     * @param  \WpPluginner\Illuminate\Database\Eloquent\Collection|array  $ids
     * @return array
     */
     ...
     *
     * @param  \WpPluginner\Illuminate\Database\Eloquent\Collection|\WpPluginner\Illuminate\Support\Collection|array  $ids
    ...
    {
        return wp_pluginner_collect($records)->mapWithKeys(function ($attributes, $id) {
