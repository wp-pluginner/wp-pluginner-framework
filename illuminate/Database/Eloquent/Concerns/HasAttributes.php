...
use WpPluginner\Illuminate\Database\Eloquent\JsonEncodingException;
...
trait HasAttributes
{
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relation instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'WpPluginner\Illuminate\Database\Eloquent\Relations\Relation');
        }

        return wp_pluginner_tap($relation->getResults(), function ($results) use ($method) {
    ...
    {
        return wp_pluginner_tap($this->getArrayAttributeByKey($key), function (&$array) use ($path, $value) {
    ...
    {
        static::$mutatorCache[$class] = wp_pluginner_collect(static::getMutatorMethods($class))->map(function ($match) {
