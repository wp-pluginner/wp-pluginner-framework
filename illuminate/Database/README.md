...
```PHP
use WpPluginner\Illuminate\Database\Capsule\Manager as Capsule;
...
use WpPluginner\Illuminate\Events\Dispatcher;
...
```PHP
class User extends WpPluginner\Illuminate\Database\Eloquent\Model {}
