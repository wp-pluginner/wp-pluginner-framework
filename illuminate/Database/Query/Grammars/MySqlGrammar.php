...
use WpPluginner\Illuminate\Database\Query\JsonExpression;
...
class MySqlGrammar extends Grammar
{
    ...
    {
        return wp_pluginner_collect($values)->map(function ($value, $key) {
     ...
     *
     * @param  string  $key
     * @param  \WpPluginner\Illuminate\Database\Query\JsonExpression  $value
     * @return string
     */
    ...
    {
        $values = wp_pluginner_collect($values)->reject(function ($value, $column) {
    ...
    protected function wrapJsonSelector($value)
    {
        ...
        return sprintf('%s->\'$.%s\'', $field, wp_pluginner_collect($path)->map(function ($part) {
            return '"'.$part.'"';
        })->implode('.'));
    }
