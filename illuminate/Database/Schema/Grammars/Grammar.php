...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \WpPluginner\Illuminate\Support\Fluent  $column
     * @return string
     */
     ...
     * @param  \WpPluginner\Illuminate\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \WpPluginner\Illuminate\Support\Fluent|null
     */
     ...
     *
     * @param  \WpPluginner\Illuminate\Database\Query\Expression|string  $value
    ...
    public function getDoctrineTableDiff(Blueprint $blueprint, SchemaManager $schema)
    {
        ...
        return wp_pluginner_tap(new TableDiff($table), function ($tableDiff) use ($schema, $table) {
