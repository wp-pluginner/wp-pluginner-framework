...
class SQLiteGrammar extends Grammar
{
    ...
    protected function addForeignKeys(Blueprint $blueprint)
    {
        ...
        return wp_pluginner_collect($foreigns)->reduce(function ($sql, $foreign) {
     ...
     *
     * @param  \WpPluginner\Illuminate\Support\Fluent  $foreign
     * @return string
     */
    ...
    public function compileAdd(Blueprint $blueprint, Fluent $command)
    {
        ...
        return wp_pluginner_collect($columns)->map(function ($column) use ($blueprint) {
