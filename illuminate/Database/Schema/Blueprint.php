...
use WpPluginner\Illuminate\Database\Schema\Grammars\Grammar;
...
class Blueprint
{
     ...
     *
     * @var \WpPluginner\Illuminate\Support\Fluent[]
     */
    protected $columns = [];
    ...
    {
        return wp_pluginner_collect($this->commands)->contains(function ($command) {
     ...
     *
     * @return \WpPluginner\Illuminate\Support\Fluent
     */
