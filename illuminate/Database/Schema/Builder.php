...
class Builder
{
    ...
    {
        $this->build(wp_pluginner_tap($this->createBlueprint($table), function ($blueprint) use ($callback) {
            $blueprint->create();
    ...
    {
        $this->build(wp_pluginner_tap($this->createBlueprint($from), function ($blueprint) use ($to) {
            $blueprint->rename($to);
        }));
    }
     ...
     * @return \WpPluginner\Illuminate\Database\Schema\Blueprint
     */
