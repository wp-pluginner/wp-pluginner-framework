...
use WpPluginner\Illuminate\Contracts\Broadcasting\ShouldBroadcast;
use WpPluginner\Illuminate\Contracts\Events\Dispatcher as DispatcherContract;
use WpPluginner\Illuminate\Contracts\Broadcasting\Factory as BroadcastFactory;
use WpPluginner\Illuminate\Contracts\Container\Container as ContainerContract;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @param  \WpPluginner\Illuminate\Contracts\Container\Container|null  $container
     * @return void
     */
    ...
    protected function parseEventAndPayload($event, $payload)
    {
        ...
        return [$event, wp_pluginner_array_wrap($payload)];
    }
     ...
     *
     * @param  \WpPluginner\Illuminate\Contracts\Broadcasting\ShouldBroadcast  $event
     * @return void
     */
    ...
    protected function callQueueMethodOnHandler($class, $method, $arguments)
    {
        ...
        $handler->queue($this->resolveQueue(), 'WpPluginner\Illuminate\Events\CallQueuedHandler@call', [
    ...
    {
        return wp_pluginner_tap($job, function ($job) use ($listener) {
