...
namespace WpPluginner\Illuminate\Queue\Capsule;

use WpPluginner\Illuminate\Queue\QueueManager;
use WpPluginner\Illuminate\Container\Container;
use WpPluginner\Illuminate\Queue\QueueServiceProvider;
use WpPluginner\Illuminate\Support\Traits\CapsuleManagerTrait;

/**
 * @mixin \WpPluginner\Illuminate\Queue\QueueManager
 * @mixin \WpPluginner\Illuminate\Contracts\Queue\Queue
 */
class Manager
{
