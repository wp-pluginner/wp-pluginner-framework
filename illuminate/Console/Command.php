...
class Command extends SymfonyCommand
{
     ...
     *
     * @var \WpPluginner\Illuminate\Console\OutputStyle
     */
    protected $output;
    ...
    {
        return wp_pluginner_tap(new ArrayInput($arguments), function ($input) {
     ...
     *
     * @param  array   $headers
     * @param  \WpPluginner\Illuminate\Contracts\Support\Arrayable|array  $rows
