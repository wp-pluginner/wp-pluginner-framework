...
class Schedule
{
     ...
     *
     * @var \WpPluginner\Illuminate\Console\Scheduling\Event[]
     */
    protected $events = [];
     ...
     *
     * @var \WpPluginner\Illuminate\Console\Scheduling\Mutex
     */
    protected $mutex;
     ...
     * @param  array  $parameters
     * @return \WpPluginner\Illuminate\Console\Scheduling\Event
     */
    ...
    {
        return wp_pluginner_collect($parameters)->map(function ($value, $key) {
            if (is_array($value)) {
                $value = wp_pluginner_collect($value)->map(function ($value) {
    ...
    {
        return wp_pluginner_collect($this->events)->filter->isDue($app);
    }
