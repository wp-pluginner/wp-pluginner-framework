...
namespace WpPluginner\Illuminate\Support;
...
class Collection implements ArrayAccess, Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
{
    ...
    public function containsStrict($key, $value = null)
    {
        if (func_num_args() == 2) {
            return $this->contains(function ($item) use ($key, $value) {
                return wp_pluginner_data_get($item, $key) === $value;
            });
        }
     ...
     *
     * @param  \WpPluginner\Illuminate\Support\Collection|mixed  $keys
     * @return static
     */
    ...
    protected function operatorForWhere($key, $operator, $value = null)
    {
        ...
        return function ($item) use ($key, $operator, $value) {
            $retrieved = wp_pluginner_data_get($item, $key);
    ...
    public function whereIn($key, $values, $strict = false)
    {
        ...
        return $this->filter(function ($item) use ($key, $values, $strict) {
            return in_array(wp_pluginner_data_get($item, $key), $values, $strict);
        });
    }
     ...
     * @return $this
     */
    public function wp_pluginner_tap(callable $callback)
    {
    ...
    protected function valueRetriever($value)
    {
        ...
        return function ($item) use ($value) {
            return wp_pluginner_data_get($item, $value);
        };
    }
