...
use WpPluginner\Wordpress\View\Compilers\BladeCompiler;
use WpPluginner\Wordpress\View\Compilers\StringBladeCompiler;
use WpPluginner\Wordpress\View\Engines\CompilerEngine;
use WpPluginner\Illuminate\View\ViewServiceProvider as IlluminateViewServiceProvider;
...
class ViewServiceProvider extends IlluminateViewServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/config/blade.php', 'blade');
