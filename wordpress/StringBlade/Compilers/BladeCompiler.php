...
namespace WpPluginner\Wordpress\StringBlade\Compilers;

class BladeCompiler extends \WpPluginner\Illuminate\View\Compilers\BladeCompiler
{
    ...
    protected function compileRegularEchos($value)
    {
        ...
        $callback = function ($matches) {
            ...
            if ($this->contentTagsEscaped) {
                $wrapped = sprintf('wp_pluginner_e(%s)', $this->compileEchoDefaults($matches[2]));
            } else {
    ...
    protected function compileEscapedEchos($value)
    {
        ...
        $callback = function ($matches) {
            ...
            return '<?php echo wp_pluginner_e('.$this->compileEchoDefaults($matches[1]).'); ?>'.$whitespace;
        };
